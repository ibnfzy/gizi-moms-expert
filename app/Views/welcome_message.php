...
<main id="hero"
  class="relative flex min-h-screen flex-col overflow-hidden bg-gradient-to-br from-giziblue to-giziblueLight pt-32">
  <div
    class="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.35),_transparent_60%)]">
  </div>
  <div
    class="relative mx-auto flex w-full max-w-7xl flex-1 flex-col justify-center px-4 pb-16 sm:px-6 lg:flex-row lg:items-center lg:px-8">
    <div class="max-w-2xl space-y-8 text-white">
      <span
        class="inline-flex items-center rounded-full bg-white/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-white/80">Solusi
        Digital Gizi</span>
      <h1 class="text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">Sistem Pakar Kebutuhan Gizi Ibu Menyusui
      </h1>
      <p class="text-lg text-white/80 sm:text-xl">Bantu pemenuhan gizi optimal bagi ibu dan bayi dengan metode Forward
        Chaining.</p>
    ...
    <div class="mt-12 w-full max-w-lg lg:mt-0 lg:max-w-xl">
      <div class="relative rounded-[2.5rem] bg-white/10 p-1 shadow-2xl shadow-blue-900/40 backdrop-blur">
        <div class="rounded-[2rem] bg-white/90 p-6">
          <img src="/banner.jpg" alt="Ilustrasi ibu menyusui"
            class="h-full w-full rounded-2xl object-cover shadow-lg shadow-blue-500/20" />
        </div>
      </div>
    </div>
  </div>
...
<section id="features" class="bg-slate-50 py-24 text-slate-900">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-3xl text-center">
      ...
      <p class="mt-4 text-lg text-slate-600">Dirancang untuk membantu ibu menyusui memahami kebutuhan gizi secara
        menyeluruh dengan dukungan data dan pakar.</p>
    </div>
    <div class="mt-16 grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
      <div
        class="group rounded-xl bg-white p-8 shadow-lg shadow-slate-200 transition hover:-translate-y-2 hover:scale-[1.01] hover:shadow-2xl">
        ...
        <p class="mt-3 text-sm leading-relaxed text-slate-600">Algoritma cerdas mengidentifikasi kebutuhan nutrisi
          berdasarkan data ibu dan bayi secara real-time.</p>
      </div>
      <div
        class="group rounded-xl bg-white p-8 shadow-lg shadow-slate-200 transition hover:-translate-y-2 hover:scale-[1.01] hover:shadow-2xl">
        ...
        <p class="mt-3 text-sm leading-relaxed text-slate-600">Ratusan kombinasi menu sehat yang disesuaikan dengan
          preferensi, alergi, dan target nutrisi harian.</p>
      </div>
      <div
        class="group rounded-xl bg-white p-8 shadow-lg shadow-slate-200 transition hover:-translate-y-2 hover:scale-[1.01] hover:shadow-2xl">
        ...
        <p class="mt-3 text-sm leading-relaxed text-slate-600">Terhubung dengan ahli gizi profesional untuk memvalidasi
          rekomendasi dan menjawab pertanyaan Anda.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="roles" class="bg-white py-24">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-3xl text-center">
      ...
      <p class="mt-4 text-lg text-slate-600">Kolaborasi yang memastikan setiap rekomendasi gizi tersampaikan tepat
        sasaran.</p>
    </div>
    <div class="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
      <div class="rounded-3xl border border-blue-100 bg-blue-50 p-8 transition hover:-translate-y-2 hover:shadow-2xl">
        ...
        <p class="mt-3 text-sm leading-relaxed text-blue-800/80">Kelola data pengguna, aturan inferensi, dan menjaga
          sistem tetap mutakhir.</p>
      </div>
      <div
        class="rounded-3xl border border-purple-100 bg-purple-50 p-8 transition hover:-translate-y-2 hover:shadow-2xl">
        <div class="text-4xl">👩‍⚕️</div>
        <h3 class="mt-6 text-xl font-semibold text-purple-900">Pakar Gizi</h3>
        <p class="mt-3 text-sm leading-relaxed text-purple-800/80">Validasi hasil inferensi serta memberikan saran
          personal sesuai kondisi ibu dan bayi.</p>
      </div>
      <div class="rounded-3xl border border-pink-100 bg-pink-50 p-8 transition hover:-translate-y-2 hover:shadow-2xl">
        ...
        <p class="mt-3 text-sm leading-relaxed text-pink-800/80">Menerima panduan menu sehat, pemantauan nutrisi, dan
          pengingat konsumsi harian.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="download"
  class="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-500 to-indigo-700 py-24 text-white">
  ...
  <div
    class="relative mx-auto max-w-5xl rounded-3xl border border-white/10 bg-white/10 px-8 py-16 text-center shadow-2xl backdrop-blur-lg sm:px-16">
    ...
    <div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
      <a href="https://drive.google.com/file/d/1jY6lqKDX9ssKSrgWwKHCRJHN2yVsiyNI/view?usp=sharing"
        class="inline-flex items-center justify-center rounded-full bg-gizigreen px-8 py-3 text-base font-semibold text-white shadow-lg shadow-emerald-500/30 transition hover:-translate-y-1 hover:shadow-emerald-500/50"
...
<footer class="bg-[#1f2937] py-10 text-sm text-white">
  <div
    class="mx-auto flex max-w-7xl flex-col gap-8 px-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
