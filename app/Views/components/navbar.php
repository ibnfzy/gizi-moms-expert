    ...
    <div class="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400">Monitoring kondisi gizi dan rekomendasi nutrisi harian.</p>
            </div>
        </div>
        <div class="flex items-center justify-end gap-3 text-sm text-slate-500 dark:text-slate-400">
            ...
            >
                ...
                <span aria-hidden="true" data-theme-icon="moon" class="hidden h-4 w-4 text-slate-200">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M21 12.75a8.25 8.25 0 0 1-8.25 8.25 8.25 8.25 0 0 1-7.882-5.535.75.75 0 0 1 1.096-.867 5.999 5.999 0 0 0 7.362-9.088.75.75 0 0 1 .816-1.216A8.25 8.25 0 0 1 21 12.75Z" />
                    </svg>
                </span>
            </button>
            <div class="hidden text-right sm:block">
                <p class="font-medium text-slate-700 dark:text-slate-200">Hai, <?= esc($userName) ?>!</p>
                <p class="text-xs uppercase tracking-wide text-slate-400 dark:text-slate-500"><?= esc(strtoupper($userRole)) ?></p>
            </div>
            <a
                href="<?= site_url('logout') ?>"
                class="inline-flex items-center rounded-md bg-giziblue px-3 py-2 text-sm font-semibold text-white shadow hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-giziblue focus:ring-offset-2 dark:focus:ring-offset-slate-900"
            >Keluar</a>
        </div>
    </div>
</header>
