...
<div
  ...
  <div class="overflow-x-auto">
    <table class="min-w-full border-collapse border border-black/30 dark:border-gray-300">
      <thead
      ...
      <tbody class="text-sm text-slate-700 dark:text-slate-200">
        ...
        <tr>
          <td colspan="6"
            class="border border-black/30 px-6 py-6 text-center text-sm text-slate-500 dark:border-gray-300 dark:text-slate-400">
        ...
        <tr class="transition hover:bg-slate-50 dark:hover:bg-slate-900/60">
          ...
          <td class="border border-black/30 px-6 py-4 text-sm text-slate-500 dark:border-gray-300 dark:text-slate-400">
